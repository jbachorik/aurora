...
public final class SeriesMatcher {
    ...
    public record Candidate(TitleCandidate series, Optional<Map<Integer, Integer>> episodesPerSeason) {
    }
    ...
    static double titleScore(TitleCandidate candidate, Optional<TitleGuess> guess, String folderName) {
        double best = 0;
    ...
    private static List<String> names(TitleCandidate candidate) {
